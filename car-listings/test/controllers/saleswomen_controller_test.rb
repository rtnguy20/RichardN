...
class SaleswomenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create saleswoman" do
    assert_difference('Saleswoman.count') do
      post saleswomen_url, params: { saleswoman: { description: @saleswoman.description, fullname: @saleswoman.fullname, profile_image_url: @saleswoman.profile_image_url } }
    end
  ...
  test "should update saleswoman" do
    patch saleswoman_url(@saleswoman), params: { saleswoman: { description: @saleswoman.description, fullname: @saleswoman.fullname, profile_image_url: @saleswoman.profile_image_url } }
